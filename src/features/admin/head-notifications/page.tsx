...
import {
  useHeadNotificationsQuery,
  useMarkHeadNotificationAsReadMutation,
  useDeleteHeadNotificationMutation,
} from "@/hooks/queries/use-head-notifications-queries";
import { getApiErrorMessage } from "@/lib/api/api-error";
import { getNotificationTitle, type NotificationItem } from "@/services/notifications.service";
import type { NotificationDataSummary } from "@/services/head-notifications.service";
...
export function HeadNotificationsPage() {
  const t = useTranslations("admin");

  const query = useHeadNotificationsQuery();

  const markRead = useMarkHeadNotificationAsReadMutation();
  const deleteNotif = useDeleteHeadNotificationMutation();
  ...
  return (
    <AdminLayout activePath={routes.adminHeadNotifications}>
