...
**Execution Date**: 2026-08-22T10:18:48.172Z
...
| `GET /public/departments/8/programs` | Public | 200 | Array: YES | ID: YES | Name: YES | Degree: NO | DeptID: YES | Count: 1 | First Program: اللغة العربية والإعلام | **PASS** | Programs for department 8 |
...
| `POST /auth/register (Test Student)` | Student | 200 | Token: YES | User: YES | NationalID (<=20 chars): YES | Registered student audit_student_1787393886328@university.edu.ps | **PASS** | Registration succeeded and returned valid JWT token |
| `GET /auth/me (Student)` | Student | 200 | ID: YES | Email: YES | Role: YES | Name: YES | NationalID: YES | Email: audit_student_1787393886328@university.edu.ps | NationalID: 962337724 | **PASS** | National ID present directly in /auth/me |
| `GET /student/profile` | Student | 200 | DataObj: YES | PI Key: YES | Name Key: YES | NationalID: YES | Tawjihi Key: YES | Name: طالب فحص تجريبي | NationalID: 962337724 | Contact: YES | **PASS** | Profile normalized cleanly without fake values |
...
| `GET /admin/applications` | Admin | 200 | Not 403: YES | Array: YES | ID: YES | Applicant: YES | Status: YES | AppNo: YES | Count: 19 | First: APP-37859730 | **PASS** | Admin applications list (19 records) |
