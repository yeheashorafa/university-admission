...
**Execution Date**: 2026-08-28T12:13:39.044Z
...
| `GET /public/faculties` | Public | 500 | Array: YES | ID: YES | NameAr: YES | NameEn: YES | Code: YES | Count: 0 | First: N/A | **BACKEND_500** | Sample faculty ID: None |
...
| `POST /auth/register (Test Student)` | Student | 200 | Token: YES | User: YES | NationalID (<=20 chars): YES | Registered student audit_student_1787919182086@university.edu.ps | **PASS** | Registration succeeded and returned valid JWT token |
| `GET /auth/me (Student)` | Student | 200 | ID: YES | Email: YES | Role: YES | Name: YES | NationalID: YES | Email: audit_student_1787919182086@university.edu.ps | NationalID: 973857719 | **PASS** | National ID present directly in /auth/me |
| `GET /student/profile` | Student | 403 | DataObj: YES | PI Key: NO | Name Key: NO | NationalID: NO | Tawjihi Key: NO | Name: Missing | NationalID: Missing | Contact: NO | **BACKEND_403** | Backend profile missing national_id key in payload |
| `GET /student/social-information` | Student | 403 | Unwrapped: YES | Birth Keys: YES | Guardian Keys: YES | Contact Keys: YES | Work Keys: YES | Birth Place: null | City: null | Guardian: null | **BACKEND_403** | extractResource unwrap verified; optional nulls handled without crash |
| `GET /student/applications` | Student | 403 | Array: YES | ID: YES | Status: YES | Program/Prefs: YES | Cycle: YES | Count: 0 | Status: Empty list (Valid) | **BACKEND_403** | Empty applications list handled as valid |
| `GET /student/dashboard` | Student | 403 | Unwrapped: YES | Stats Obj: YES | Total Apps: NO | Docs Count: YES | Notifs: YES | Stats: {"message":"Please verify your account."} | **BACKEND_403** | Dashboard statistics unwrapped and mapped |
| `GET /student/documents` | Student | 403 | Array: YES | ID: YES | TypeID: YES | Count: 0 | **BACKEND_403** | 0 student uploaded documents |
| `GET /student/notifications` | Student | 403 | Array: YES | ID: YES | Message: YES | Count: 0 | **BACKEND_403** | 0 student notifications |
...
| `GET /admin/notifications` | Admin | 200 | Array: YES | ID: YES | Type: YES | Message: YES | FailedRowsSafe: YES | Count: 3 | **PASS** | Admin notifications endpoint verified with secondary school import payload checks |
